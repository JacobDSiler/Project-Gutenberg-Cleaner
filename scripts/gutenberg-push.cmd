@echo off
REM ---------------------------------------------------------------------------
REM  gutenberg-push.cmd — double-click launcher for gutenberg-push.ps1
REM
...
REM
REM  Usage: put this next to gutenberg-push.ps1 in the same directory (ideally
REM  at <repo>\scripts\) and double-click it.
REM ---------------------------------------------------------------------------

setlocal
set "HERE=%~dp0"
set "PS1=%HERE%gutenberg-push.ps1"

if not exist "%PS1%" (
    echo Could not find gutenberg-push.ps1 next to this launcher.
